...
//
//    float SafePositionBackOffset = 5.f;
//
...
class AGEOFWOLVES_API UANS_MW_FixPositionWhenCollide : public UAnimNotifyState
{
    //@친추 클래스
#pragma region Friend Class
#pragma endregion
...
#pragma region Default Setting
public:
    UANS_MW_FixPositionWhenCollide(const FObjectInitializer& ObjectInitializer);
...
public:
    ...
    // 충돌 시 위치 고정 여부
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Collision")
    bool bFixPositionOnCollision = true;
